...
def test_synchronization_for_main_branch():
    """Test standard synchronization from the main branch."""
...
def test_synchronization_not_for_main():
    """Test standard synchronization from a branch different than main."""
